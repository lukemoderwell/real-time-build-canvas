    ...
    <AnimatePresence>
      {feature && (
        <motion.div
          ...
          className="absolute right-0 top-0 h-full w-96 bg-card border-l border-border shadow-2xl z-40 flex flex-col"
        >
          {/* Header */}
          ...
          {/* Content */}
          <ScrollArea className="flex-1 px-4 bg-card">
                  ...
                  <div className="space-y-3">
                    {feature.conversationHistory.map((entry, idx) => (
                      <div key={idx} className="border border-border rounded-lg p-3 bg-card">
                        ...
                        {entry.insights && (
                          <div className="text-xs text-muted-foreground italic border-l-2 border-primary pl-2 bg-secondary/30 rounded-r">
                            {entry.insights}
                          </div>
                        )}
                      </div>

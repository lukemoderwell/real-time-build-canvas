    ...
    >
      <div className="p-3 border-b border-border bg-secondary/30 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-xs font-medium uppercase tracking-wider text-muted-foreground">Coding Agent</h3>
        </div>
          ...
          {activeTasks.map((task) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="truncate font-medium text-xs text-foreground mb-0.5">{task.title}</div>
